...
const TaskList = ({tasks}) => {
    ...
    const handleEdit = (e, id) => {
        ...
        axios.patch(`http://localhost:4000/tasks/${id}`, {
            name: 'Edit button was Used',
            detail: 'Text is hard-coded. Couldnt firgure out how to make a form and edit'
        })
    }
            ...
            {tasks.map((task) => (
                <div className="preview" key={task.id}>
                    <div className="d-flex justify-content-between">
                        ...
                        <div className="">
                            <button onClick={(e) => handleEdit(e, task.id)} className="btn btn-secondary mt-3" type="submit"><svg xmlns="http://www.w3.org/2000/svg" width="16" height="16" fill="currentColor" class="bi bi-pencil-square" viewBox="0 0 16 16">
