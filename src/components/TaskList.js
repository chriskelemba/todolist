            ...
            {tasks.map((task) => (
                <div className="preview" key={task.id}>
                    <div className="d-flex justify-content-between">
                        ...
                        <div className="">
                            <button onClick={handleDelete} className="btn btn-secondary mt-3 mx-4" type="submit"><svg xmlns="http://www.w3.org/2000/svg" width="16" height="16" fill="currentColor" class="bi bi-trash3 mb-1" viewBox="0 0 16 16">
