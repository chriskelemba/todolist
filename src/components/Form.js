        ...
        <div>
            <form className="form">
                <div className="input-group p-3 mx-auto">
                    ...
                    <input type="text" className="form-control" name="title" placeholder="Add a task detail..."/><br/>
                    <button onClick="" className="btn btn-secondary px-4" type="submit"><svg xmlns="http://www.w3.org/2000/svg" width="16" height="16" fill="currentColor" class="bi bi-check-circle" viewBox="0 0 16 16">
