        ...
        <div>
            <form className="form" onSubmit={handleSubmit}>
                <div className="input-group p-3 mx-auto">
                    ...
                    <input type="text" className="form-control" name="name" value={data.name} onChange={handleChange} placeholder="Add a task..."/><br/>
                    <input type="text" className="form-control" name="detail" value={data.detail} onChange={handleChange} placeholder="Add a task detail..."/><br/>
